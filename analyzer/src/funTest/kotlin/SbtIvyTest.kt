...
import com.here.ort.analyzer.managers.SbtIvy
...
class SbtIvyTest : StringSpec({
    "Dependencies of the single 'directories' project should be detected correctly" {
        ...
        val ortResult = Analyzer(DEFAULT_ANALYZER_CONFIGURATION).analyze(projectDir, listOf(SbtIvy.Factory()))
